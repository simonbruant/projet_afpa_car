...
from .views import DashboardView, PrivateDataUpdateView, UserUpdateView, CalendarView, CarCreateView, CarUpdateView, email, FormationSessionCreateView, PreferencesUpdateView
